...
| 安全 | `entities._QUESTION_MARKERS` | 问询标记表**覆盖不全**：有「是否」没有「是不是」、有「有没有」没有句尾式「…过没有」、有「多少」漏了「多久」。验收方用一份**独立**措辞清单（32 句，修复方没见过）测出 3 处误伤：「7 月的退款金额是不是被调整过？」「退款金额被调整过没有？」「营业额一般多久更新一次？」 | 待修（D1-05 ②c，建议改结构判据而不是继续加词） |
