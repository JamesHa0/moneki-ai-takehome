...
| 安全 | `entities._HEAD_IMPERATIVE` 不看动词后缀 | "句首动词 = 祈使"忽略了中文的**名词化定语**：「动词 + 的/过/前/后/完」是定语不是命令。②d 因此在良措辞上**新开 8 条误伤**（②c 上 0 条 → ②d 上 8 条，同一批 19 句量出来的）：「删除的订单还能恢复吗？」「更新过的销售记录在哪查？」等。**验收方已四版对照验证"加定语豁免"为 0 条不符预期** | 待修（D1-05 ②e，改法一小段判断） |
